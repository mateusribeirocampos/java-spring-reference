...
INSERT INTO tb_offer (edition, start_moment, end_moment, course_id) VALUES ('1.0', TIMESTAMP WITH TIME ZONE '2021-09-01T03:00:00Z', TIMESTAMP WITH TIME ZONE '2022-09-01T03:00:00Z', 2);
INSERT INTO tb_offer (edition, start_moment, end_moment, course_id) VALUES ('1.0', TIMESTAMP WITH TIME ZONE '2022-03-01T03:00:00Z', TIMESTAMP WITH TIME ZONE '2023-03-01T03:00:00Z', 3);

-- USER x OFFER
INSERT INTO tb_user_offer (user_id, offer_id) VALUES (1, 1);
INSERT INTO tb_user_offer (user_id, offer_id) VALUES (1, 2);
INSERT INTO tb_user_offer (user_id, offer_id) VALUES (2, 2);
INSERT INTO tb_user_offer (user_id, offer_id) VALUES (2, 3);
INSERT INTO tb_user_offer (user_id, offer_id) VALUES (3, 4);
...
-- TOPICS
INSERT INTO tb_topic (title, body, moment, user_id, offer_id, lesson_id, answer_id) VALUES ('Encapsulation and Abstraction', 'Why encapsulation and abstraction can work together?', TIMESTAMP WITH TIME ZONE '2026-05-03T16:24:50Z', 1, NULL, 12, NULL);
INSERT INTO tb_topic (title, body, moment, user_id, offer_id, lesson_id, answer_id) VALUES ('Dúvida sobre normalização 3FN', 'Como decidir quando uma tabela já está em 3FN sem overengineering?', TIMESTAMP WITH TIME ZONE '2026-05-04T10:30:00Z', 3, 4, 9, NULL);
INSERT INTO tb_topic (title, body, moment, user_id, offer_id, lesson_id, answer_id) VALUES ('Polimorfismo em interfaces', 'Quando usar interface ao invés de classe abstrata em Java?', TIMESTAMP WITH TIME ZONE '2026-05-05T14:15:00Z', 2, 3, 14, NULL);
...
-- REPLIES
INSERT INTO tb_reply (body, moment, topic_id, author_id) VALUES ('Abstraction and encapsulation work together to create robust, maintainable, and secure object-oriented systems by addressing different but complementary aspects of software design', TIMESTAMP WITH TIME ZONE '2026-05-03T16:24:50Z', 1, 2);
INSERT INTO tb_reply (body, moment, topic_id, author_id) VALUES ('Uma regra prática é validar dependências funcionais e remover dependências transitivas antes de concluir 3FN.', TIMESTAMP WITH TIME ZONE '2026-05-04T12:00:00Z', 2, 1);
INSERT INTO tb_reply (body, moment, topic_id, author_id) VALUES ('Prefira interface quando houver múltiplas implementações e contrato estável; abstrata quando compartilhar estado/comportamento base.', TIMESTAMP WITH TIME ZONE '2026-05-05T15:00:00Z', 3, 3);

-- USER x REPLY
INSERT INTO tb_user_reply (user_id, reply_id) VALUES (2, 1);
INSERT INTO tb_user_reply (user_id, reply_id) VALUES (1, 2);
INSERT INTO tb_user_reply (user_id, reply_id) VALUES (3, 3);
...
INSERT INTO tb_deliver (uri, moment, status, feedback, correct_count, lesson_id, user_id, offer_id) VALUES ('https://www.ischool.com/submission/sql-db-project', TIMESTAMP WITH TIME ZONE '2026-06-07T23:59:59Z', 2, 'Muito bom, apenas ajustar nomenclaturas de colunas.', 4, 10, 3, 2);
